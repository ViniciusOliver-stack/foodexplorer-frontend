            ...
            {user.isAdmin ? (
              ...
              <Infos>
                ...
                <Button
                  ...
                  icon={FiMail}
                  onClick={() =>
                    (window.location = 'mailto:contato@foodexplorer.com')
                  }
                />
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      'https://api.whatsapp.com/send?phone=+999999999999&text=Oi pessoal do FoodExplorer! Gostaria de falar sobre o meu pedido!',
                      '_blank'
                    )
                  }
                />
